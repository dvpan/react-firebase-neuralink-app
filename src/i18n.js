        ...
        resources: {
            en: {
                translations: {
                    ...
                    "Еще нет аккаунта?<1> Зарегистрироваться</1>": "Don't have an account yet?<1> Sign Up</1> ",
                    "Уже есть аккаунт?<1> Войти</1>": "Already have an account?<1> Sign In</1>",
            ...
            ru: {
                translations: {
                    ...
                    "Еще нет аккаунта?<1> Зарегистрироваться</1>": "Еще нет аккаунта?<1> Зарегистрироваться</1>",
                    "Уже есть аккаунт?<1> Войти</1>": "Уже есть аккаунт?<1> Войти</1>",
